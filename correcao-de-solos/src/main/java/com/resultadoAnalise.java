...
public class resultadoAnalise {
    private double quantidadeFosforo;
    private double quantidadePotassio;
    private double quantidadeCalcio;
    private double quantidadeMagnesio;
    private double quantidadeEnxofre;
    private double quantidadeAluminio;
    private double quantidadeAcidezPotencial;
